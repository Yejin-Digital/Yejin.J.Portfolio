...
import image from '../assets/montro_image1.jpg';
import image from '../assets/poster_image1.jpg';
  ...
  return (
    <div className={style.landingProject}>
      ...
      <div className={style.projectLayoutLeft}>
        <img src={image} alt="Montro Project" />
        <p>Interface</p>
        <p>User Experience</p>
        <img src={image} alt="Poster design project" />
      </div>
