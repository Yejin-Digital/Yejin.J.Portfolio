        ...
        <section id="challenges" className={style.contentSection}>
          ...
          <div className={style.challengesCard}>
            <div className={style.challengesContent}>
              <div className={style.challengesTop}>
                <p className={style.challengesProblem}>
                  The design prioritizes mobile devices for their portability
                  and convenience. The user can track information, check
                  eligibility, and prepare applications at any time and from any
                  location. However, most grants still require users to apply
                  through official website forms, which are typically designed
                  for desktop use.
                </p>
              </div>
              <div className={style.challengesBottom}>
                ...
                <p className={style.challengesSolution}>
                  To address this, Scaffold offers a web supplement feature for
                  users. When users sign in on a desktop, they can view their
                  generated templates. Users can apply by clicking a button that
                  takes them directly to the application website, where they can
