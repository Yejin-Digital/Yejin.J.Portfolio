    ...
    <div className={style.page}>
      <div className={style.section1}>
        ...
        <div className={style.buttons}>
          <Buttons label="ALL" variant="category" icon={null} />
          <Buttons label="Graphic" variant="category" icon={null} />
          <Buttons label="Motion" variant="category" icon={null} />
          <Buttons label="Packaging" variant="category" icon={null} />
        </div>
      </div>
