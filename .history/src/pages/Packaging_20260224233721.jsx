        ...
        <section className={style.infoSection}>
          <div className={style.conceptTextWrap}>
            ...
            <p className={style.conceptText}>
              ...
              ensuring every bottle is easily identifiable. A unified layout
              connects all flavors, using framed labels and splash graphics to
              highlight the drink’s sparkling quality. Centered fruit
              photography emphasizes the organic purity and freshness of each
              ingredient. Altogether, the design balances visual appeal with
              clear communication, encouraging children’s interest and assuring
              parents of its organic quality.
            </p>
          </div>
