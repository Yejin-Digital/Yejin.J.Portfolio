        ...
        <section className={style.infoSection}>
          <div className={style.conceptTextWrap}>
            ...
            <p className={style.conceptText}>
              <strong>StoneVine</strong> is a 100% organic sparkling fruit juice
              for young children, featuring green grape, peach, and mango
              flavors. The brand identity combines playful adventure with trust,
              appealing to both children and parents. <br /> The design features
              rounded, bubbly lettering to convey a sense of freshness and fun.
              Each flavor uses a distinct color palette and bold fruit imagery,
              ensuring every bottle is easily identifiable. <br /> A unified
              layout connects all flavors, using framed labels and splash
              graphics to highlight the drink’s sparkling quality. Centered
              fruit photography emphasizes the organic purity and freshness of
              each ingredient. Altogether, the design balances visual appeal
              with clear communication, encouraging children’s interest and
              assuring parents of its organic quality.
            </p>
          </div>
