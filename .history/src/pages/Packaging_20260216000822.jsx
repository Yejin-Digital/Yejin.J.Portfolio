      ...
      <div className={style.content}>
        ...
        <section className={style.labelSection}>
          ...
          <div className={style.dielineItems}>
            ...
            <span
              className={selectedFruit === 'Green Grape' ? style.selected : ''}
        ...
        <section className={style.infoSection}>
          ...
          <p className={style.conceptText}>
            ...
            different flavors. To appeal to young customers, the use of round
            and bubbly fonts, along with fruit photographs at the center of the
            designs, facilitates easy identification of the flavors.
          </p>
