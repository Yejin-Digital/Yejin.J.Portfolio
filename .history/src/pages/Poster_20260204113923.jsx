      ...
      <div className={style.content}>
        ...
        <section className={style.infoSection}>
          ...
          <p className={style.conceptText}>
            ...
            three brands, capturing the gritty energy and free spirit of street
            culture. While maintaining a consistent layout, the design creates
            visual energy with bold typography. Each brand stands out through
            strong textures and custom typefaces designed to match its shoe’s
            unique style.
          </p>
