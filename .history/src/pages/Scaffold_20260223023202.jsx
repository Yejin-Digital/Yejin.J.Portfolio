            ...
            <div className={style.lofiContent}>
              ...
              <div className={style.lofiText}>
                ...
                <div className={style.lofiBlock}>
                  ...
                  <p>
                    Summary of the user&apos;s app use, including grant
                    information and profile-building progress.
                  </p>
                </div>
                <div className={style.lofiBlock}>
                  <h3 className={style.lofiBlockTitle}>Profile</h3>
                  <p>
                    Users input extensive background information using a
                    quiz-style layout with options to pause or change answers.
                  </p>
                </div>
                <div className={style.lofiBlock}>
                  <h3 className={style.lofiBlockTitle}>Grant application</h3>
                  <p>
                    General grant details, application steps, and templates.
                    Card and chip features for clarity, spaced-out information,
                    and drop-down buttons for easy navigation.
                  </p>
                </div>
              </div>
            </div>
