        ...
        <section className={style.infoSection}>
          <div className={style.conceptTextWrap}>
            ...
            <p className={style.conceptText}>
              ...
              order. Maps, images, and text are used in a simple and balanced
              way. The design focuses on the travel route and the overall
              experience without visual clutter.
            </p>
          </div>
