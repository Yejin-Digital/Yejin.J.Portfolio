      ...
      <div className={style.contentBelowTitle}>
        ...
        <section id="user-persona" className={style.contentSection}>
          ...
          <p className={style.personaDescription}>
            Each grant has specific application requirements, so it is important
            to understand the applicant’s identity, situation, and conditions to
            provide appropriate solutions. User personas are built for groups
            such as women, Indigenous people, and international students to
            design products that meet their unique needs and lifestyles.
          </p>
