...
import magazineImg1 from '../assets/magazine_preview.jpg';
import magazine2 from '../assets/magazine2.jpg';
import magazine3 from '../assets/magazine3.jpg';
import magazine4 from '../assets/magazine4.jpg';
import magazine5 from '../assets/magazine5.jpg';
import magazine6 from '../assets/magazine6.jpg';
import magazine7 from '../assets/magazine7.jpg';
import magazine8 from '../assets/magazine8.jpg';
import magazineMockup1 from '../assets/magazine_mockup1.jpg';
import magazineMockup3 from '../assets/magazine_mockup3.jpg';
import magazineMockup2 from '../assets/magazine_mockup2.jpg';
import magazineMockup4 from '../assets/magazine_mockup4.jpg';
...
import subtitleLogo from '../assets/gAdventure.svg';
...
export default function Magazine() {
  ...
  const handlePrev = () => {
    setCurrentImageIndex((prev) =>
      prev === 0 ? magazineImages.length - 1 : prev - 1,
    );
  };

  const handleNext = () => {
    setCurrentImageIndex((prev) =>
      prev === magazineImages.length - 1 ? 0 : prev + 1,
    );
  };
    ...
    <div className={style.page}>
      <div className={style.titleSection}>
        ...
        <div className={style.imageSection}>
          <img className={style.image1} src={magazineImg1} alt="Magazine" />
        </div>
      </div>
        ...
        <section className={style.infoSection}>
          <div className={style.conceptTextWrap}>
            ...
            <p className={style.conceptText}>
              This book-style brochure presents a G.Adventure’s tour from Athens
              to Istanbul. The layout and photos guide readers through the
              journey, with maps, images, and text kept simple and balanced. The
              design highlights the travel route and experience, avoiding
              unnecessary clutter.
              <br />
              The cover features collage techniques to showcase the journey's
              highlights, inviting readers to experience them at a glance.
            </p>
          </div>
      ...
      <section className={style.mockupSection}>
        <Mockup
          image1={magazineMockup1}
          image2={magazineMockup4}
          image3={magazineMockup3}
          image4={magazineMockup2}
          name1="magazine mockup 2"
          name2="magazine mockup 3"
          name3="magazine mockup 4"
          name4="magazine mockup 2"
        />
        <Link to="/projects" className={style.nextProjectLink}>
