      ...
      <div className={style.stage}>
        <div className={style.logoWrap}>
          ...
          <div className={style.landingText} aria-hidden>
            <p
              className={`${style['landing-text__paragraph']} ${style.landingText_UxUi}`}
            >
              UX/UI Design
            </p>
            <p
              className={`${style['landing-text__paragraph']} ${style.landingText_MotionGraphic}`}
            >
              Motion Graphic
            </p>
            <p
              className={`${style['landing-text__paragraph']} ${style.landingText_ProductDesign}`}
            >
              Product Design
            </p>
            <p
              className={`${style['landing-text__paragraph']} ${style.landingText_GraphicDesign}`}
            >
              Graphic Design
            </p>
          </div>
